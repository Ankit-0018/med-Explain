  ...
  medicineCards: [
    ...
    },
    {
      ...
      details: {
        ...
        effectiveness: "Take at evenly spaced intervals to maintain constant blood levels.",
        precautions: "Inform your doctor if you have a history of penicillin allergy.",
        warning: "Complete the entire course to prevent antibiotic resistance.",
        dosageGuidance: "Can be taken with or without food, but food helps reduce stomach upset."
      },
    },
    {
      id: "3",
      ...
      timing: ["morning", "night"],
      duration: "5 days",
      instructions: "Take for pain or fever. Max 4 doses in 24h.",
      status: "active",
      priority: "normal",
      confidence: 42,
      color: "#f43f5e",
      validation: {
        ...
        confidence: 0.45,
        suggested_correction: "Paracetamol",
        flags: ["low_confidence", "possible_misspelling", "unknown_brand"],
        context_relevance: "possible",
        final_medicine: "Paracetamol",
        store_in_db: false
      },
      details: {
        why: "Prescribed to control fever and reduce throat pain from your infection.",
